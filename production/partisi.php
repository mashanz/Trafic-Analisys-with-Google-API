...
<?php
  ...
  echo "<b>Presisi:</b> ( ".$presisi_lancar." + ".$presisi_padat." + ".$presisi_macet." ) / 3 = <b>".$presisi_total."%</b><br>";
  echo "<b>Recall :</b> ( ".$recall_lancar." + ".$recall_padat." + ".$recall_macet." ) / 3 = <b>".$recall_total."%</b><br>";
  echo "<b>Akurasi:</b> ( ( ".$LL." + ".$PP." + ".$MM." ) / ".$total_data." * 100 ) = <b>".$accuracy."%<br>";
?>
