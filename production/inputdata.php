...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "demo-form2")) {
  $insertSQL = sprintf("INSERT INTO data_kemacetan (hari, jam, lokasi, kondisi) VALUES (%s, %s, %s, %s)",
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form action="<?php echo $editFormAction; ?>" method="POST" name="demo-form2" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <input type="hidden" name="MM_insert" value="demo-form2">
                    </form>
                  </div>
                </div>
              </div>
