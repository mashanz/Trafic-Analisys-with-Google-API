...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "demo-form2")) {
  $updateSQL = sprintf("UPDATE data_kemacetan SET hari=%s, jam=%s, lokasi=%s, kondisi=%s WHERE id=%s",
...
mysql_select_db($database_koneksi, $koneksi);
$query_Recordset4 = "SELECT * FROM kondisi";
...
mysql_select_db($database_koneksi, $koneksi);
$query_Recordset5 = sprintf("SELECT * FROM data_kemacetan WHERE id = %s", GetSQLValueString($colname_Recordset5, "int"));
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Input data kemacetan</small></h2>
                  ...
                  <div class="x_content">
                    <br />
                    <form action="<?php echo $editFormAction; ?>" method="POST" name="demo-form2" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Hari
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="hari" id="hari" class="form-control" required>
                            <option value="<?php echo $row_Recordset5['hari']; ?>"><?php echo $row_Recordset5['hari']; ?> </option>
                            <?php do { ?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <select name="waktu" id="waktu" class="form-control" required>
                           <option value="<?php echo $row_Recordset5['jam']; ?>"><?php echo $row_Recordset5['jam']; ?></option>
                            <?php do { ?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <select name="lokasi" id="lokasi" class="form-control" required>
                              <option value="<?php echo $row_Recordset5['lokasi']; ?>"><?php echo $row_Recordset5['lokasi']; ?></option>
                              <?php do { ?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <select name="kondisi" id="kondisi" class="form-control" required>
                            <option value="<?php echo $row_Recordset5['kondisi']; ?>"><?php echo $row_Recordset5['kondisi']; ?></option>
                            <?php do { ?>
                            <option value="<?php echo $row_Recordset4['kondsi']; ?>"><?php echo $row_Recordset4['kondsi']; ?></option>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                         <input type="hidden" name="id" value="<?php echo $row_Recordset5['id']; ?>">
						  <button class="btn btn-primary" type="reset">Reset</button>
                          <button type="submit" class="btn btn-success">Update</button>
                        </div>
                      </div>
                      <input type="hidden" name="MM_update" value="demo-form2">
                    </form>
                  </div>
                </div>
              </div>
